...
class IseedTest extends TestCase
{
    ...
    public function __construct()
    {
        ...
        static::$stubsDir = __DIR__ . '/../src/SchuBu/Iseed/Stubs';
    ...
    {
        $this->expectException(\SchuBu\Iseed\TableNotFoundException::class);
        $this->expectExceptionMessage('Table nonexisting was not found.');

        $hasTable = m::mock('SchuBu\Iseed\Iseed[hasTable]')->makePartial();
    ...
    public function testCanGetStubPath()
    {
        ...
        $expected = substr(__DIR__, 0, -5).'src'.DIRECTORY_SEPARATOR.'SchuBu'.DIRECTORY_SEPARATOR.'Iseed'.DIRECTORY_SEPARATOR.'Stubs';
    ...
    public function testCanGenerateSeed()
    {
        ...
        $mocked = m::mock(\SchuBu\Iseed\Iseed::class, [$file, $composer])->makePartial();
        $mocked->shouldReceive('readStubFile')
               ->once()
               ->with(substr(__DIR__, 0, -5).'src'.DIRECTORY_SEPARATOR.'SchuBu'.DIRECTORY_SEPARATOR.'Iseed'.DIRECTORY_SEPARATOR.'Stubs'.DIRECTORY_SEPARATOR.'seed.stub');
